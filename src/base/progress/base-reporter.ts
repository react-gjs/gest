...
export abstract class BaseReporter {
   ...
   *
   * If a report was indeed printed, this method should return
   * `true`, otherwise return `false`.
   */
  printErrorReports(): boolean {
    return false;
  }

  /**
   * When this method is called, a summary of all the Test Suites
   * and Test Units should be printed to the console.
   */
  printSummary(summary: SummaryInfo): void {}
}
